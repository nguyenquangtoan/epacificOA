...
var domain_name ='cdn.jsdelivr.net';
var main_domain_name = 'epacific.net';
var orgin_domain = '';
var ssl = 's';
// var root_url = 'http' + ssl + '://' + domain_name + '/gh/nguyenquangtoan/epacificOA@prod/';
var root_url = domain_name + "/gh/nguyenquangtoan/epacificOA@main/";
...
{
    document.cookie = cookie_name + "=; expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/; domain=." + parentdomain + ";";
}
